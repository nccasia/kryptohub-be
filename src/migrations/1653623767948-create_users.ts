...
export class createUsers1653623767948 implements MigrationInterface {
    name = 'createUsers1653623767948'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "username" character varying NULL, "emailAddress" character varying NULL, "password" character varying NULL, "githubAddress" character varying NULL, "googleAddress" character varying NULL, "link" character varying NULL, "status" character varying NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_eea9ba2f6e1bb8cb89c4e672f62" UNIQUE ("emailAddress"), CONSTRAINT "UQ_d6502c3d803c1828a537a0a648b" UNIQUE ("githubAddress"), CONSTRAINT "UQ_aa1a1c396be19b9454a65377b0c" UNIQUE ("googleAddress"), CONSTRAINT "UQ_b8ca70e5b6ff2fbd0aa6ff3b85a" UNIQUE ("link"), CONSTRAINT "UQ_3d44ccf43b8a0d6b9978affb880" UNIQUE ("status"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
